        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    img.setAttribute('data-id', list[i].id);
                    img.setAttribute('data-uuid', list[i].uuid);
                    img.setAttribute('data-hash', list[i].hash);
                    img.setAttribute('data-url', list[i].url);
                    img.setAttribute('data-alt', list[i].original);
                    img.setAttribute('data-title', list[i].title);
