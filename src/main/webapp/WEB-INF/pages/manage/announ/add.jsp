...
<html>
	...
	<legend><i class="layui-icon">&#xe63c;</i> 添加公告信息</legend>
	<div class="layui-field-box">
	<form action="${path }/annoMgr/add.shtml" class="layui-form layui-form-pane" method="post" id="mainForm">
    ...
    <textarea id="ueditorAnn" cols="" rows=""  style="border:0px;padding:0px;width:1300px; height:610px; overflow:hidden;">
    </textarea>
    </div>
		...
		$.ajax({
			...
			success:function(data){
				if (data.code == 0) {
					...
					window.parent.closeTab('hc.announ.annoMgr.add');
				} else {
