...
<html>
	...
	<span class="layui-breadcrumb" style="visibility: visible;">
	  ...
	  <a >联系我们管理</a>
	  <a><cite>编辑联系我们</cite></a>
	</span>
	<br><br>
	
	<fieldset class="layui-elem-field">
	<legend><i class="layui-icon">&#xe63c;</i> 编辑联系我们</legend>
	<div class="layui-field-box">
	<form action="${path }/conMgr/edit.shtml" class="layui-form layui-form-pane" method="post" id="mainForm">
	<input type="hidden" value="${contact.CON_ID }" name="conId">
    ...
    <textarea id="ueditorCnt" cols="" rows=""  style="border:0px;padding:0px;width:1300px; height:610px; overflow:hidden;">${contact.CON_CONTENT }</textarea>
    </div>
